                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                     ...
                     <?php if(Session::has('message')): ?>
                        <div id="alert" class="alert alert-sucess"><?php echo e(Session::get('message')); ?></div>
                    <?php endif; ?>
                                ...
                                <?php $i=1; foreach($admins as $admin){?>
                                    <tr class="odd gradeX">
                                       <td><?= $i++;?></td>
                                        ...
                                        <td><a  class="fa fa-pencil btn btn-primary" href="<?php echo e(route('admin.edit',$admin->id)); ?>"></a>&nbsp;&nbsp;&nbsp;<a class="fa fa-trash btn btn-danger" href="<?php echo e(route('admin.destroy',$admin->id)); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
                                            </a>
                                        </td>
                                    </tr>
                                    <?php }?>
